...
// @ts-ignore
import plugin, { IAMPersonalizationResponse } from './index';

const personalizationResponse = personalizationEdgeResponse.mock({
  uuid: '1',
  payload: {
    ...
    id: '1',
    scope: btoa(
      JSON.stringify({ activityId: 'activity1', placementId: 'placement1' })
    ),
    activity: {
      id: 'activity1'
    },
    ...
    items: [
      {
        id: 'item1',
        data: {
          content: JSON.stringify({ rules: ['123'] }),
          id: 'data1'
        }
      }
    ]
...
const personalizationResponseInvalidScope = personalizationEdgeResponse.mock({
  uuid: '1',
  payload: {
    ACPExtensionEventData: {
      type: 'personalization:decisions'
    ...
    id: '1',
    scope: btoa(
      JSON.stringify({ activityId: 'activity2', placementId: 'placement2' })
    ),
    activity: {
      id: 'activity1'
    },
...
const personalizationResponseInvalidContent = personalizationEdgeResponse.mock({
  uuid: '1',
  payload: {
    ACPExtensionEventData: {
      type: 'personalization:decisions'
...
const test = {
  ...
  payload: {
    ...
    ACPExtensionEventData: {
      payload: [
        {
          ...
          scope: 'eyJ4ZG06bmFtZSI6ImNvbS5hZG9iZS5kZW1vc3lzdGVtLmR4ZGVtbyJ9',
          id: '18f14a88-da6f-4149-874c-b0da8ddaae4c',
          items: [
            {
              etag: '1',
              data: {
      ...
      requestId: 'C4FAF702-6FBF-4F78-947D-406879EDF5DF',
      type: 'personalization:decisions',
      requestEventId: 'EBE2D71A-D726-4882-808B-A3C5D2ED6FCE'
    },
    ACPExtensionEventSource: 'personalization:decisions',
    ACPExtensionEventName: 'AEP Response Event Handle',
    ACPExtensionEventUniqueIdentifier: 'CDE5FD61-F6FC-41FC-80CC-752840EDAAAC'
  },
  annotations: []
};

describe('AEP IAM Response Events', () => {
  ...
  it('should return errors when content is not correct', () => {
    const result = plugin([personalizationResponseInvalidContent]);
