...
const { type = 'view' } = require('minimist')(process.argv.slice(2));
...
(() => {
  ...
  const { displayName, namespace, src, version } = R.pick(['displayName', 'namespace', 'src', 'version'], descriptor);
  ...
  if (type === 'view') {
    zipArchive.file('./dist/react.js');
    zipArchive.file('./dist/vendor.js');
  }
